...
<body>
    <div class="login__wrapper install">
                            ...
                            <div data-v-fade-in class="login_form__inner">
                                ...
                                <div class="other_methods">
                                    ...
                                    <div class="registration_block">
                                        ...
                                        <a href="https://id.multibank.uz/" class="registration_link">Зарегистрироваться бесплатно</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <script src="https://b24.alphacon.uz/local/dev/check.contragents.app/scripts/jquery.js"></script>

        <script src="https://b24.alphacon.uz/local/dev/check.contragents.app/scripts/install.min.js?v=<?=$random?>"></script>
</body>
</html>
