...
document.querySelector("[data-pass].password-input span").addEventListener('click', (e) => {
    ...
    document.querySelector('#install_btn').addEventListener("click" , (e) => {
        ...
        BX24.init(async function(){                                 
            ...
            // BX24.callBind ("onCrmContactAdd","https://b24.alphacon.uz/local/dev/check.contragents.app/app/app.handler.php",function(result){
            //     if(result.error()){
            //         console.error(result.error());
            //     }
            // });
            ...
            // BX24.callBind ("onCrmCompanyAdd","https://b24.alphacon.uz/local/dev/check.contragents.app/app/app.handler.php",function(result){
            //     if(result.error()){
            //         console.error(result.error());
            //     }
            // });
            ...
            // BX24.callBind ("onCrmDealAdd","https://b24.alphacon.uz/local/dev/check.contragents.app/app/app.handler.php",function(result){
            //     if(result.error()){
            //         console.error(result.error());
            //     }
            // });
        
            const handlerUrl = `https://b24.alphacon.uz/local/dev/check.contragents.app/app/app.field.php`;
            const type = 'check_contragents_type';
            const oldType = 'crm_cpv_type';
            const companyField = 'CHECK_CONTRAGENTS';
