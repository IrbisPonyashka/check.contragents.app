        ...
        <script type="module">
            BX24.init(async function(){
                ...
                if(placementInfo.options){
                    ...
                    if(domain == 'micros.bitrix24.ru'){
                        var urlClient = `https://micros.uz/it/solutions_our/multicheck.app/v2/scripts/clientHandler.js?v=${random}`;
                        var urlDeal = `https://micros.uz/it/solutions_our/multicheck.app/v2/scripts/dealHandler.js?v=${random}`;
                    }else{
                        var urlClient = `https://micros.uz/it/solutions_our/multicheck.app/v2/scripts/clientHandler.min.js?v=${random}`;
                        var urlDeal = `https://micros.uz/it/solutions_our/multicheck.app/v2/scripts/dealHandler.min.js?v=${random}`;
                    }
